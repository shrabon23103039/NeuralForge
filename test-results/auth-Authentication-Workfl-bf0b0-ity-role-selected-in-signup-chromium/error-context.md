...
- Name: auth.spec.ts >> Authentication Workflow >> should show department dropdown when authority role selected in signup
- Location: e2e\auth.spec.ts:87:7
...
Call log:
  - waiting for getByRole('button', { name: /authority officer/i })
...
- generic [ref=e1]:
  - banner [ref=e2]:
    - generic [ref=e3]:
      - link "Nirapod Dhaka Safety Net" [ref=e4] [cursor=pointer]:
        - /url: /
        - generic [ref=e8]:
          - text: Nirapod
          - generic [ref=e9]: Dhaka Safety Net
      - navigation [ref=e10]:
        - link "Risk Map" [ref=e11] [cursor=pointer]:
          - /url: /
        - link "Report Hazard" [ref=e15] [cursor=pointer]:
          - /url: /report
        - link "Authority Portal" [ref=e18] [cursor=pointer]:
          - /url: /authority
      - generic [ref=e23]:
        - button "EMERGENCY SOS" [ref=e24]
        - button "বাংলা" [ref=e27]
  - main [ref=e31]:
    - generic [ref=e32]:
      - link "Back to Map" [ref=e33] [cursor=pointer]:
        - /url: /
      - generic [ref=e36]:
        - generic [ref=e37]:
          - heading "Sign In to Nirapod" [level=1] [ref=e41]
          - paragraph [ref=e42]: Dhaka Citizen & Authority Access Portal
        - generic [ref=e43]:
          - generic [ref=e44]:
            - generic [ref=e45]: Email Address
            - textbox "user@example.com" [ref=e50]
          - generic [ref=e51]:
            - generic [ref=e52]: Password
            - textbox "••••••••" [ref=e57]
          - button "Sign In" [ref=e58]
        - button "Need an account? Sign up" [active] [ref=e60]
  - contentinfo [ref=e61]: Nirapod Prototype © 2026 — Built for Dhaka Citizen Safety & Emergency Resilience.
```
