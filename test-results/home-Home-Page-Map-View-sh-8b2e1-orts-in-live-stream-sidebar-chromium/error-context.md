...
- Name: home.spec.ts >> Home Page & Map View >> should display seeded reports in live stream sidebar
- Location: e2e\home.spec.ts:105:7
...
Locator: getByText('View details →').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('View details →').first()
