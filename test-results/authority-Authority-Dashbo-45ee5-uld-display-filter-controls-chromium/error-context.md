...
- Name: authority.spec.ts >> Authority Dashboard Workflow >> should display filter controls
- Location: e2e\authority.spec.ts:28:7
...
Locator: getByText('Filter by Department')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Filter by Department')
