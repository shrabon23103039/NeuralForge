...
- Name: auth.spec.ts >> Authentication Workflow >> should show error for invalid login credentials
- Location: e2e\auth.spec.ts:118:7
...
Call log:
  ...
  - waiting for locator('.bg-red-950')
