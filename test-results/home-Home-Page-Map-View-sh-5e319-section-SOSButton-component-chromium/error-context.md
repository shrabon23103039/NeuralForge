...
- Name: home.spec.ts >> Home Page & Map View >> should trigger SOS from hero section SOSButton component
...
Locator: locator('main').getByText('SOS Alert Activated!')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('main').getByText('SOS Alert Activated!')
