...
- Name: home.spec.ts >> Home Page & Map View >> should toggle language between English and Bangla
- Location: e2e\home.spec.ts:88:7
...
Locator: locator('h1')
Expected substring: "ঢাকা"
Received string:    "Dhaka Citizen Safety & Hazard Platform"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    13 × locator resolved to <h1 class="text-2xl md:text-3xl font-extrabold text-white tracking-tight">Dhaka Citizen Safety & Hazard Platform</h1>
       - unexpected value "Dhaka Citizen Safety & Hazard Platform"
