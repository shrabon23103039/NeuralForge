...
- Name: authority.spec.ts >> Authority Dashboard Workflow >> should navigate to authority from navbar
- Location: e2e\authority.spec.ts:145:7
...
Expected pattern: /\/authority/
Received string:  "http://127.0.0.1:3000/login?redirect=%2Fauthority"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × locator resolved to <html lang="en">…</html>
       - unexpected value "http://127.0.0.1:3000/login?redirect=%2Fauthority"
