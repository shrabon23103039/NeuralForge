...
- Name: authority.spec.ts >> Authority Dashboard Workflow >> should show AI Executive Briefing button
- Location: e2e\authority.spec.ts:137:7
...
Locator: getByRole('button', { name: /generate ai executive briefing/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /generate ai executive briefing/i })
